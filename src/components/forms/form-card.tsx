...
export function FormCardHeader({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
    <CardHeader
      className={cn(
...
export function FormCardDescription({ children }: { children: React.ReactNode }) {
  return <CardDescription>{children}</CardDescription>
}

export function FormCardContent({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
    <CardContent
      className={cn(
        "px-4 last:pb-4 group-has-data-[slot=card-upgrade]:pointer-events-none group-has-data-[slot=card-upgrade]:opacity-50",
        className
      )}
      {...props}
    >
...
export function FormCardSeparator({ ...props }: React.ComponentProps<typeof Separator>) {
  return <Separator {...props} />
}

const formCardFooterVariants = cva("border-t flex items-center gap-2 pt-4 pb-4 px-4 [&>:last-child]:ml-auto", {
  variants: {
    variant: {
      default: "",
...
export function FormCardFooterInfo({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
...
export function FormCardGroup({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
...
export function FormCardUpgrade({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
...
export function FormCardEmpty({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
